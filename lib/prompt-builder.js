...
- Must stay under 280 characters. Aim for 70-220.
...
- No emoji unless the original tweet already uses that energy and it clearly helps.
...
${TONE_INSTRUCTIONS[tone] || TONE_INSTRUCTIONS.witty}`;
  ...
  sections.push("<task>");
  sections.push("Write one reply with maximum reply-worthiness and shareability.");
  sections.push("The reply should feel native to X and worth responding to.");
  sections.push("</task>");

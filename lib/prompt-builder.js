const TONE_INSTRUCTIONS = {
  witty: `Dry, sharp, and socially fluent. Use one clever turn of phrase or clean reversal. Prioritize insight over joke density. Think smart group-chat energy, not stand-up. Avoid puns, corniness, or trying too hard. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  supportive: `Warm, credible, and useful. Validate the underlying point, then add a sharper insight, example, or implication. Sound like a thoughtful peer, not a cheerleader. Avoid empty praise or therapy-speak. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  contrarian: `Respectfully challenge one premise with a stronger framing. Be crisp and confident, not combative. The goal is "here’s the better take," not dunking. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  informative: `Add one non-obvious fact, mechanism, or consequence that makes the thread smarter. Lead with the insight itself. Avoid "Actually," "FYI," or textbook energy. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  provocative: `Make a bold but defensible point that creates productive tension. Anchor it in a principle, tradeoff, or future consequence. Be sharp enough to spark replies, not so hostile it feels like bait. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  analytical: `Compress the issue into a clean pattern, tradeoff, or second-order effect. Sound precise, high-signal, and readable. One sharp framework beats a long explanation. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  skeptical: `Question the assumption calmly and intelligently. Pull at the weak point without sounding cynical or smug. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  visionary: `Zoom out and connect the tweet to a bigger shift, future outcome, or broader pattern. Make it feel prescient, not fluffy. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  question: `Reply with a single sincere question. No preamble, no commentary — just one honest, curious question that shows you actually care about the answer. It should feel like something you’d genuinely ask in a real conversation. Avoid rhetorical questions, leading questions, or anything clever. Just ask what you actually want to know. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  agreeable: `Sincerely agree and build on the point. Add a concrete example, a stronger implication, or a personal angle that shows you genuinely get it. Sound like an ally who sharpens the argument, not a yes-man. Avoid empty validation — every agreement should make the original point hit harder. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,

  disagreeable: `Sincerely and respectfully disagree. Name the specific point you push back on and offer a cleaner counter-argument or overlooked tradeoff. Be direct and honest, not hostile. The goal is a real intellectual exchange — disagree like someone whose respect you’d want to earn, not like a troll. Write at a 5th grade reading level — use simple words, short clear sentences, and explain ideas in an easy-to-understand way while keeping the original meaning.`,
};
